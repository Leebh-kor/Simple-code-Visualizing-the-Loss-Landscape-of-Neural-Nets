...
def h5_to_vtp(surf_file, surf_name='train_loss', log=True, zmax=10, interp=-1):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--surf_file', default='resnet56_3d_surface_file.h5', help='The h5 file that contains surface values')
    parser.add_argument('--surf_name', default='train_loss',
		help='The type of surface to plot: train_loss | test_loss | train_acc | test_acc ')
    parser.add_argument('--zmax', default=8, type=float, help='Maximum z value to map')
